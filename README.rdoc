= rhn_satellite
master: {<img src="https://api.travis-ci.org/arusso/ruby-rhn_satellite.png" />}[https://travis-ci.org/arusso/ruby-rhn_satellite]
development: {<img src="https://api.travis-ci.org/arusso/ruby-rhn_satellite.png" />}[https://travis-ci.org/arusso/ruby-rhn_satellite]
...
RedHat's API is documented here: https://access.redhat.com/documentation/en-US/Red_Hat_Satellite/5.6/pdf/API_Overview/Red_Hat_Satellite-5.6-API_Overview-en-US.pdf
